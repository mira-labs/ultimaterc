...
# Install script for Debian: only install if missing
function install_tools_debian_once() {
...
if [ -z "$BASHRC_DEBIAN_TOOLS_INSTALLED" ]; then
  install_tools_debian_once
  export BASHRC_DEBIAN_TOOLS_INSTALLED=1
fi
